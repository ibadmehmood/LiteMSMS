...
{
    public partial class frmSaleProfitReport : Form
    {
        ...
        long totalBalance;
        public frmSaleProfitReport(frmMain frmMain)
        {
        ...
        {
            frmSaleProfitReportViewer frmSaleReportViewer = new frmSaleProfitReportViewer(from, to);
