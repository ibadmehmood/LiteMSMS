...
namespace Mobile_Shop_Management_System
{
    public partial class frmPurchaseReport : Form
    {
        ...
        long totalBalance;
        public frmPurchaseReport(frmMain frmMain)
        {
        ...
        {
            frmPurchaseReportViewer frmPurchaseReportViewer = new frmPurchaseReportViewer(from, to);
            frmPurchaseReportViewer.MdiParent = frmMain;
            frmPurchaseReportViewer.WindowState = FormWindowState.Maximized;

            frmPurchaseReportViewer.Show();
